          ...
          <div>
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-6">
              ...
              <div className="lg:col-span-1 lg:pr-16 flex flex-wrap justify-center lg:flex-col lg:justify-start -m-1 lg:mx-0">
                <button
                  className={`lg:w-full font-medium px-3 py-2 shadow-sm transition duration-150 ease-in-out rounded-sm flex items-center justify-center lg:justify-start m-1 lg:mx-0 ${category === '1' ? 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600/25 dark:hover:bg-teal-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'}`}
                ...
                <button
                  className={`lg:w-full font-medium px-3 py-2 shadow-sm transition duration-150 ease-in-out rounded-sm flex items-center justify-center lg:justify-start m-1 lg:mx-0 ${category === '2' ? 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600/25 dark:hover:bg-teal-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'}`}
                ...
                <button
                  className={`lg:w-full font-medium px-3 py-2 shadow-sm transition duration-150 ease-in-out rounded-sm flex items-center justify-center lg:justify-start m-1 lg:mx-0 ${category === '3' ? 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600/25 dark:hover:bg-teal-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'}`}
                ...
                <button
                  className={`lg:w-full font-medium px-3 py-2 shadow-sm transition duration-150 ease-in-out rounded-sm flex items-center justify-center lg:justify-start m-1 lg:mx-0 ${category === '4' ? 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600/25 dark:hover:bg-teal-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'}`}
                ...
                <button
                  className={`lg:w-full font-medium px-3 py-2 shadow-sm transition duration-150 ease-in-out rounded-sm flex items-center justify-center lg:justify-start m-1 lg:mx-0 ${category === '5' ? 'bg-teal-500 hover:bg-teal-500 dark:bg-teal-600/25 dark:hover:bg-teal-600/25' : 'bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700'}`}
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">2 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">4 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className={['1', '3'].includes(category) ? undefined : 'hidden'}>
                    <div className="relative flex justify-center items-center shadow-sm">
                      <Image className="w-full" src={VideoThumb} width={352} height={264} alt="Video thumbnail 01" />
                      <div className="absolute inset-0 flex flex-col">
                        <div className="grow flex justify-center items-center">
                          <a className="hover:opacity-75 transition duration-150 ease-in-out" href="#0">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">7 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center shadow-sm">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">9 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center shadow-sm">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">12 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center shadow-sm">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">3 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center shadow-sm">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">11 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative flex justify-center items-center shadow-sm">
                      ...
                      <div className="absolute inset-0 flex flex-col">
                        ...
                        <div className="w-full bottom-0 px-6 py-3 bg-white opacity-90 dark:bg-gray-900 flex justify-between items-center">
                          ...
                          <div className="inline-flex px-3 py-1 text-xs font-medium text-white bg-gray-900/50 dark:text-teal-400 dark:bg-teal-600/25 rounded-full">6 Min</div>
                        </div>
                      </div>
                    </div>
                  </div>
